              ...
              <div className="flex-1 flex flex-col gap-5">
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    aria-label="Toggle lock room with PIN"
                    title={lockRoom ? "Unlock room" : "Lock room with PIN"}
                    onClick={() => { setLockRoom(!lockRoom); setError(''); }}
                    className={cn("w-10 h-5 rounded-full relative transition-colors shadow-inner focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900", lockRoom ? "bg-teal-500" : "bg-zinc-800 border border-white/5")}
                  >
                  ...
                  <>
                    <div className="flex items-center justify-between mt-2">
                      ...
                      <button 
                        ...
                        aria-label="Toggle custom permanent link"
                        title={isPersistent ? "Disable permanent link" : "Enable permanent link"}
                        onClick={() => { setIsPersistent(!isPersistent); setError(''); }}
                        className={cn("w-10 h-5 rounded-full relative transition-colors shadow-inner focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900", isPersistent ? "bg-teal-500" : "bg-zinc-800 border border-white/5")}
                      >
