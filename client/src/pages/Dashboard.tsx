              ...
              <div className="flex-1 flex flex-col gap-5">
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className={cn(
                      "w-10 h-5 rounded-full relative transition-colors shadow-inner focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950", 
                      lockRoom ? "bg-teal-500" : "bg-zinc-800 border border-white/5"
                    )}
                  >
                  ...
                  <>
                    <div className="flex items-center justify-between mt-2">
                      ...
                      <button 
                        ...
                        className={cn(
                          "w-10 h-5 rounded-full relative transition-colors shadow-inner focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950", 
                          isPersistent ? "bg-teal-500" : "bg-zinc-800 border border-white/5"
                        )}
                      >
