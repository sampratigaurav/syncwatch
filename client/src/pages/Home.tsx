                   ...
                   <div className="animate-in fade-in slide-in-from-top-2 duration-300 mt-1">
                     ...
                     <div className="relative w-full">
                        <input
                          ...
                          className={cn(
                            "w-full h-12 tablet:h-[52px] min-h-[48px] bg-zinc-900/80 border rounded-lg px-4 tablet:px-5 pr-10 tablet:pr-12 text-zinc-100 [.light_&]:text-zinc-900 focus:outline-none focus:ring-4 transition-all duration-200 placeholder:text-zinc-600 text-sm font-normal font-mono tracking-widest",
                        ...
                        <button
                          ...
                          className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-500 hover:text-zinc-300 [.light_&]:text-zinc-400 [.light_&]:hover:text-zinc-600 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500/70 rounded-sm"
                        >
                          {showCreatePin ? <EyeOff size={18} aria-hidden="true" /> : <Eye size={18} aria-hidden="true" />}
                        </button>
                     </div>
                   ...
                   <div className="animate-in fade-in slide-in-from-top-2 duration-300 mt-1">
                     ...
                     <div className="relative w-full">
                        ...
                        <button
                          ...
                          className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-500 hover:text-zinc-300 [.light_&]:text-zinc-400 [.light_&]:hover:text-zinc-600 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500/70 rounded-sm"
                        >
                          {showJoinPin ? <EyeOff size={18} aria-hidden="true" /> : <Eye size={18} aria-hidden="true" />}
                        </button>
                     </div>
