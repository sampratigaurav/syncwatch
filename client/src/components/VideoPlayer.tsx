                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      {subtitleBlobUrl && (
                        <button 
                          ...
                          className={cn(
                            "w-10 h-5 rounded-full relative transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950",
