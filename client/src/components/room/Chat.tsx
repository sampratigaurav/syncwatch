      ...
      <div className="pt-2 flex-shrink-0 relative">
        <form onSubmit={handleSend} className="relative group">
          ...
          <button 
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 p-2 text-teal-500 hover:text-teal-400 hover:bg-white/5 rounded-lg transition-colors disabled:opacity-50 disabled:hover:bg-transparent disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500/70"
          >
