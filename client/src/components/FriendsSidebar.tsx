  ...
  return (
    <>
      <button 
        ...
        title="Friends"
        className="fixed bottom-6 right-6 p-4 bg-teal-600 hover:bg-teal-500 text-white rounded-full shadow-[0_0_20px_rgba(20,184,166,0.3)] transition-all z-40 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
      >
              ...
              <div className="p-6 pb-0 relative z-10">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-bold text-white flex items-center gap-2">
                    <Users className="text-teal-500" aria-hidden="true" />
                    Friends
                  </h2>
                  <button
                    onClick={() => setIsOpen(false)}
                    ...
                    title="Close"
                    className="p-2 hover:bg-white/10 rounded-full transition-colors text-zinc-400 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                  >
                ...
                <div className="flex gap-2 mb-8 relative group">
                  ...
                  <button 
                    ...
                    className="relative px-4 bg-teal-600 hover:bg-teal-500 text-white rounded-xl transition-all disabled:opacity-50 disabled:hover:bg-teal-600 shadow-lg active:scale-95 flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                  >
                            ...
                            return (
                              <div key={edge.id} className="flex items-center justify-between p-3 rounded-xl bg-teal-500/5 border border-teal-500/10 transition-colors">
                                ...
                                <div className="flex items-center gap-1">
                                  <button onClick={() => handleAcceptRequest(edge.requesterId)} aria-label="Accept friend request" className="p-1.5 bg-teal-500/20 hover:bg-teal-500/30 text-teal-400 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500" title="Accept">
                                    <Check size={16} aria-hidden="true" />
                                  </button>
                                  <button onClick={() => handleRemoveFriend(edge.requesterId)} aria-label="Decline friend request" className="p-1.5 hover:bg-white/10 text-zinc-400 hover:text-red-400 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400" title="Decline">
                                    <X size={16} aria-hidden="true" />
                                  </button>
                                </div>
                              </div>
                          ...
                          outgoingReqs.map(edge => {
                            ...
                            return (
                              <div key={edge.id} className="flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/5 transition-colors">
                                ...
                                <button onClick={() => handleRemoveFriend(targetUid)} aria-label="Cancel friend request" className="p-1.5 hover:bg-white/10 text-zinc-500 hover:text-red-400 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400" title="Cancel Request">
