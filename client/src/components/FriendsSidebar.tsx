            ...
            >
              ...
              <div className="p-6 pb-0 relative z-10">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button onClick={() => setIsOpen(false)} className="p-2 hover:bg-white/10 rounded-full transition-colors text-zinc-400 hover:text-white" aria-label="Close friends sidebar" title="Close friends sidebar">
                            ...
                            return (
                              <div key={edge.id} className="flex items-center justify-between p-3 rounded-xl bg-teal-500/5 border border-teal-500/10 transition-colors">
                                ...
                                <div className="flex items-center gap-1">
                                  <button onClick={() => handleAcceptRequest(edge.requesterId)} className="p-1.5 bg-teal-500/20 hover:bg-teal-500/30 text-teal-400 rounded-lg transition-colors" title="Accept" aria-label="Accept friend request">
                                    <Check size={16} aria-hidden="true" />
                                  </button>
                                  <button onClick={() => handleRemoveFriend(edge.requesterId)} className="p-1.5 hover:bg-white/10 text-zinc-400 hover:text-red-400 rounded-lg transition-colors" title="Decline" aria-label="Decline friend request">
                                    <X size={16} aria-hidden="true" />
                                  </button>
                                </div>
                              </div>
                          ...
                          outgoingReqs.map(edge => {
                            ...
                            return (
                              <div key={edge.id} className="flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/5 transition-colors">
                                ...
                                <button onClick={() => handleRemoveFriend(targetUid)} className="p-1.5 hover:bg-white/10 text-zinc-500 hover:text-red-400 rounded-lg transition-colors" title="Cancel Request" aria-label="Cancel friend request">
