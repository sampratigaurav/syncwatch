    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 sm:px-10 h-[60px]">
          ...
          <Link
            to="/"
            className="flex items-center gap-2.5 group shrink-0 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22d3a5] p-1 -m-1 cursor-pointer transition-transform duration-200 hover:scale-[1.02]"
          >
            <img
              src="/logo.png"
              alt="SyncWatch logo"
              width={34}
              height={34}
              className="shrink-0 rounded-[6px] group-hover:scale-105 transition-transform duration-200"
            />
            <span className="text-[16px] font-semibold tracking-[0.01em] leading-none group-hover:text-[#22d3a5] transition-colors duration-200" style={{ color: 'var(--sw-text-primary)' }}>
              SyncWatch
            </span>
          </Link>
          ...
          >
            {([
              ...
              >
                ...
                <button
                  ...
                  className="relative z-10 px-3.5 py-1.5 text-[14px] font-normal transition-all duration-150 hover:text-[#22d3a5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22d3a5] rounded-lg cursor-pointer"
            ...
            >
              ...
              <Link
                ...
                onBlur={() => setHoveredNav(null)}
                className="relative z-10 block px-3.5 py-1.5 text-[14px] font-normal transition-all duration-150 hover:text-[#22d3a5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22d3a5] rounded-lg cursor-pointer"
                style={{ color: 'var(--sw-nav-text)' }}
              >
                Docs
              </Link>
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <a
              ...
              className="group flex items-center gap-2 px-3.5 py-1.5 rounded-full border transition-all duration-200 cursor-pointer hover:border-[#22d3a5]/50 hover:bg-[#22d3a5]/10 hover:text-[#22d3a5] hover:shadow-[0_0_16px_rgba(34,211,165,0.25)] hover:-translate-y-0.5 active:translate-y-0 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22d3a5]"
              style={{
            ...
            >
              <Github className="w-4 h-4 transition-transform duration-200 group-hover:scale-110 group-hover:rotate-6 text-inherit" aria-hidden="true" />
              <span className="hidden sm:block text-[13px] font-normal tracking-wide text-inherit">Star</span>
            </a>
            ...
            {isAuthLoading ? (
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-1.5 rounded-full border text-sm font-medium transition-all duration-200 cursor-pointer hover:border-[#22d3a5]/50 hover:bg-[#22d3a5]/10 hover:shadow-[0_0_16px_rgba(34,211,165,0.25)] hover:-translate-y-0.5 active:translate-y-0 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22d3a5]"
                  style={{
                    borderColor: 'var(--sw-border)',
                    background: 'var(--sw-surface)',
                  ...
                  {isProfileDropdownOpen && (
                    ...
                    >
                      <button
                        ...
                        className="w-full text-left px-4 py-2.5 text-sm transition-colors duration-150 cursor-pointer hover:bg-[#22d3a5]/10 hover:text-[#22d3a5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22d3a5] focus-visible:ring-inset"
              ...
              <button
                ...
                className="group relative flex items-center gap-2.5 px-5 py-2 rounded-full border text-[13.5px] font-medium transition-all duration-200 cursor-pointer hover:border-[#22d3a5]/50 hover:bg-[#22d3a5]/10 hover:shadow-[0_0_16px_rgba(34,211,165,0.25)] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.97] overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22d3a5]"
                style={{
                  borderColor: 'var(--sw-border)',
                  background: 'var(--sw-surface)',
                  color: 'var(--sw-text-primary)',
              ...
              >
                ...
                <span className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-transparent via-[#22d3a5]/10 to-transparent" aria-hidden="true" />
                {/* Google G logo */}
                <svg className="relative w-3.5 h-3.5 shrink-0 group-hover:scale-110 transition-transform duration-200" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/>
                  <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
                  <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/>
                  <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/>
                </svg>
                <span className="relative group-hover:text-[#22d3a5] transition-colors duration-200">Sign in</span>
              </button>
            )}
          </div>
