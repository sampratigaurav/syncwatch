      ...
      <header className="sticky top-0 w-full z-50 backdrop-blur-xl bg-zinc-950/80 border-b border-white/10">
        <div className="max-w-7xl mx-auto grid grid-cols-2 tablet:grid-cols-3 items-center px-6 py-4">
          ...
          <nav className="hidden tablet:flex items-center justify-center gap-8">
            ...
            <button type="button" className="relative group cursor-help focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded-sm">
              ...
              <div role="tooltip" className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-3 py-1.5 bg-black border border-white/10 rounded-lg text-xs font-medium text-zinc-300 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap shadow-xl">
          ...
          <div className="flex items-center justify-end gap-4 tablet:gap-6">
            <a 
              ...
              className="text-zinc-400 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded-full"
            >
