        ...
        {blocks && (
          <div className="flex items-center gap-1.5 bg-zinc-800 [.light_&]:bg-zinc-200 rounded px-1.5 py-0.5">
            <button 
              ...
              className="text-zinc-400 hover:text-white [.light_&]:text-zinc-500 [.light_&]:hover:text-black p-0.5 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500/70"
            ...
            <span 
              className="text-[10px] font-mono text-zinc-300 [.light_&]:text-zinc-600 w-12 text-center"
              aria-live="polite"
            >
