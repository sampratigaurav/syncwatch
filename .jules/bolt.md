...
## 2026-08-26 - Conditional Unmounting over Visibility Props
**Learning:** Components subscribing to frequently updating Zustand stores (like latencyMs) will continue to re-render even if they return null based on a visibility prop, causing wasted renders.
**Action:** Unmount the component conditionally at the parent level instead of passing a visibility prop.
