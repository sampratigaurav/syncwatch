...
## 2026-07-11 - Hoisting Expensive Intl Instances
**Learning:** Recreating expensive instances like `Intl.DateTimeFormat` inside React render loops or iterating over them causes severe performance degradation on continuous re-renders.
**Action:** Hoist and cache these initializations outside components to prevent unnecessary instantiation.
