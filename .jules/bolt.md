...
## 2024-07-10 - Intl.DateTimeFormat Object Re-creation
**Learning:** Recreating expensive instances (like `Intl.DateTimeFormat`) inside React render loops and mapping functions causes performance degradation on continuous re-renders.
**Action:** Hoist and cache these initializations outside components to reuse the instance.
