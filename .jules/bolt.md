...
## 2024-07-09 - Hoisting Expensive Instances
**Learning:** Recreating expensive instances like `Intl.DateTimeFormat` inside React render loops causes severe performance degradation on continuous re-renders.
**Action:** Always hoist and cache these initializations outside components to prevent unnecessary recreations during the render cycle.
